...
BB_DEFCONFIG=configs/beaglebone_defconfig
...
MODIFIED_BB_DEFCONFIG=base_external/configs/aesd_bb_defconfig
# The defconfig from the buildroot directory we use for the project
AESD_DEFAULT_DEFCONFIG=${BB_DEFCONFIG}
AESD_MODIFIED_DEFCONFIG=${MODIFIED_BB_DEFCONFIG}
